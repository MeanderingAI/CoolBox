...
extern "C" {
    ...
    const char* get_library_name_system_monitor() { return "system_monitor"; }
    
    __attribute__((weak, used))
    const char* get_library_version_system_monitor() { return "1.5.2"; }
    
    __attribute__((weak, used))
    const char* get_library_description_system_monitor() { return "Real-time system metrics monitoring: CPU, memory, disk, network, processes, and uptime tracking"; }
    
    __attribute__((weak, used))
    const char* get_library_author_system_monitor() { return "ToolBox Team"; }
}
