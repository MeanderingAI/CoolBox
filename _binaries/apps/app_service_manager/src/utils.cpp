...
std::string handle_api_libdocs(const std::string& libdocs_path) {
    // Scan for all index.html files under libdocs_path
    dj::Array arr;
...
// New API handlers for demos, services, apps (global scope)
