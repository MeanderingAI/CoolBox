...
void ModelServer::setup_prediction_endpoint(const std::string& model_name,
    ...
    server_.post(endpoint, [predict_fn](const Request& req) {
        Response resp;
...
void ModelServer::setup_batch_prediction_endpoint(const std::string& model_name,
    ...
    server_.post(endpoint, [batch_predict_fn](const Request& req) {
        Response resp;
...
void ModelServer::setup_health_endpoint() {
    server_.get("/health", [](const Request& req) {
        Response resp;
        resp.set_status(HttpStatus::OK);
...
void ModelServer::setup_info_endpoint(const std::string& model_name,
    ...
    server_.get(endpoint, [model_name, model_type, version](const Request& req) {
        Response resp;
