...
Response Http2Server::handle_request(const Request& request) {
...
void Http2Server::handle_request_async(const Request& request,
...
void Http2Server::push_promise(const Request& original_request,
