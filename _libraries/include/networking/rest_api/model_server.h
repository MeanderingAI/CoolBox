...
#ifndef NETWORKING_REST_API_MODEL_SERVER_H
#define NETWORKING_REST_API_MODEL_SERVER_H
...
public:
    ...
    void start();
    void stop();
    networking::rest_api::Server& get_server() { return server_; }
private:
    networking::rest_api::Server server_;
...
#endif // NETWORKING_REST_API_MODEL_SERVER_H
