...
public:
    ...
    bool start() {
        ...
        std::cout << "✓ Routes:\n";
        std::cout << "  - GET  /          - Login page\n";
        std::cout << "  - POST /login     - Login handler\n";
        std::cout << "  - GET  /signup    - Signup page\n";
        std::cout << "  - POST /signup    - Signup handler\n";
        std::cout << "  - GET  /profile   - User profile\n";
        std::cout << "  - POST /profile/update - Update profile\n";
        std::cout << "  - GET  /logout    - Logout\n";
